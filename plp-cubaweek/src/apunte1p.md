...
Si $\ (\forall \text{x :: a. \ f x = g x }) \implies \text{ f = g}$
...
1. **Delete
$\{x\stackrel{?}{=}x\} \ \cup E \phantom{lllllllllllllllllllllllllllllllllll}\to \quad E$** 
2. **Decompose**
$\{C(\tau_1, ...,\tau_n)\stackrel{?}{=}C(\sigma_1,...,\sigma_n)\} \ \cup \ E \quad \to \quad \{ \tau_1 \stackrel{?}{=} \sigma_1,..., \tau_n \stackrel{?}{=}\sigma_n\} \ \cup \ E$ 
3. **Swap
$\{\tau\stackrel{?}{=}\ \textcolor{orange}{?n}\} \ \cup E \phantom{lllllllllllllllllllllllllllllllll} \to \quad \{\textcolor{orange}{?n} \stackrel{?}{=} \tau\} \cup E$**              
                                                                                  (Si $\tau$ no es una incógnita)
4. **Elim
$\{\textcolor{orange}{?n}\stackrel{?}{=}\tau\} \ \cup E \phantom{lllllllllllllllllllllll} \to_{\{?n\ := \ \tau\}} \quad E' = {\{ \textcolor{orange}{?n}} := \tau \}(E)$**
                                                                                               (Si ?n no ocurre en $\tau$)
5. **Clash
$\{C(\tau_1, ...,\tau_n)\stackrel{?}{=}C(\sigma_1,...,\sigma_n)\} \ \cup \ E \phantom{lll}\to \quad \text{falla}$**      (Si $C \neq C')$
6. **Occurs-Check**
$\{\textcolor{orange}{?n}\stackrel{?}{=}\tau\} \ \cup E \phantom{lllllllllllllllllllllllllllllllll}\to \quad \text{falla}$      (Si $?n \neq \tau \; \text{y} \; ?n$ ocurre en $\tau$)
