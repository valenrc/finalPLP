...
Una expresion se puede reducir de diferentes maneras. Algunas expresiones pueden no tener forma normal. Pero podemos demostrar que una expresión tiene una única forma normal. 
...
La semántica operacional es una forma de definir el significado de una función de manera **dinámica**, como una serie de operaciones que se realizan para obtener un resultado, mas parecido a un algoritmo.
